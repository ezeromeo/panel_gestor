...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (messageText) {
            ...
            messageDiv.className = 'messageContainer d-flexa align-items-end justify-content-end';
            ...
            // Asegura que el ajuste del scroll ocurre después de que el DOM se ha actualizado
            setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tableBody = document.getElementById('tableBodyProfesores');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    dataModoTabla.forEach(item => {
        ...
        if (isSpecialDay) {
            row.className = 'special-day';
        } else{
            row.className = 'normal-day'
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const controlData = [
      ...
      tableContainer.innerHTML = createTableDataControl(controlData);
